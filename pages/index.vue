      ...
      <div class="chatbox">
        ...
        <div class="custom-tab-1">
          ...
          <div class="tab-content">
            <div id="chat" class="tab-pane fade active show" role="tabpanel">
              <div
            ...
            <div id="alerts" class="tab-pane fade" role="tabpanel">
                    ...
                    <div class="col-xl-6">
                      <div class="card-bx bg-blue">
                        ...
                        <a class="change-btn" href="javascript:void(0);"
                          ><i class="fa fa-caret-up up-ico"></i>Change<span
                            class="reload-icon"
                            ><i class="fa fa-refresh reload active"></i></span
                        ></a>
                      </div>
                    </div>
                    <div class="col-xl-6">
                      <div class="row mt-xl-0 mt-4">
                        <div class="col-md-6">
                          ...
                          <ul class="card-list mt-4">
                            <li>
                              <span class="bg-blue circle"></span>Account<span
                                >20%</span
                              >
                            </li>
                            <li>
                            ...
                            <li>
                              <span class="bg-light circle"></span>Others<span
                                >15%</span
                              >
                            </li>
                          </ul>
              ...
              <div class="card">
                ...
                <div class="card-body">
                  ...
                  <h4 class="mt-3 mb-3">
                    Recent Friend<a
                      href="javascript:void(0);"
                      class="fs-16 float-end text-secondary font-w600"
                      >See More</a
                    >
                  </h4>
                  <ul class="user-list">
            ...
            <div class="col-xl-3 col-xxl-5">
              <div class="card">
                ...
                <div class="card-footer border-0 pt-0">
                  <a
                    href="javascript:void(0);"
                    class="btn btn-outline-primary d-block btn-lg"
                    >View More</a
                  >
                </div>
              </div>
            ...
            <div class="col-xl-6 col-xxl-7">
              <div class="card">
                <div class="card-header d-flex flex-wrap border-0 pb-0">
                  ...
                  <a
                    href="javascript:void(0)"
                    class="btn btn-rounded btn-md btn-primary mr-3 me-3"
                    ><i class="las la-download scale5 me-3"></i>Download
                    Report</a
                  >
                  <div class="dropdown">
                    <a
                ...
                <div class="card-body pb-2">
                  <div class="d-sm-flex d-block">
                    <div
                      class="form-check toggle-switch text-end form-switch me-4"
                    >
                      <input
            ...
            <div class="col-xl-6 col-xxl-12">
              <div class="card">
                ...
                <div class="card-body tab-content p-0">
                      ...
                      >
                        <tbody>
                          <tr>
                            ...
                            <td>
                              <span class="fs-16 text-black font-w600"
                                >+$5,553</span
                              >
                            </td>
                            <td>
                  ...
                  <div id="Weekly" class="tab-pane" role="tabpanel">
                    <div class="table-responsive">
                      <table
                        class="
                          table table-responsive-md
                  ...
                  <div id="Today" class="tab-pane" role="tabpanel">
                    <div class="table-responsive">
                      <table
                        class="
                          table table-responsive-md
                ...
                <div class="col-md-6">
                  <div class="card progress-card">
                    <div class="card-body d-flex">
                      ...
                      <div
                        class="progress progress-vertical-bottom"
                      ...
                      <div class="d-flex align-items-center">
                        <div class="me-auto">
                          ...
                          <p class="fs-16 mb-0 mt-2">
                            <span class="text-danger">-0,8% </span>from last
                            month
                          </p>
                        </div>
      ...
      <div class="footer">
        <div class="copyright">
          <p>
            ...
            <a href="https://dexignlab.com/" target="_blank">DexignLab</a> 2021
          </p>
        </div>
      </div>
      <!--**********************************
